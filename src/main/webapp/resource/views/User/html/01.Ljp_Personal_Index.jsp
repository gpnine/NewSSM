...
<div id="per_container">
        ...
        <div class="rigHead_h1">
            <div class="h1_part1">
                ...
                <div class="h1_xx">
                    ...
                    <p class="h1_zhaq"><a href="16.Ljp_Personal_Index.html">账户安全：<span class="aqd"><span
                            class="h1_span"></span></span>&nbsp;&nbsp;&nbsp;中</p></a>
                    <p class="h1_thr">
            ...
            <c:forEach items="${wineList2}" var="item">
                <div class='box'>
                    <div class='mother'>
                        ...
                        <li class='goods_li'><img class='goods_img'
                                                  src='<%=basePath%>/resource/views/img/${item.getWineImg1()}'
                                                  style="width: 184px;height: 182px;"/>
                        <li class='goods_hover'>
                            <a class='xfWord' href='<%=basePath%>/wine/goods.do?wid=${item.getWId()}'>去购买 ></a>
                        </li>
                        </li>
    ...
    <div id="rig_recode">
        <div class="rec_head">
            <span class="rec_gg1">——</span>
            <div class="rec_hea">浏览记录</div>
            <span class="rec_gg2">——</span>
            <c:forEach items="${wineList}" var="item">
                <li class='rec_li'>
                    <a href='<%=basePath%>/wine/goods.do?wid=${item.getWId()}'><img
                            src="<%=basePath%>/resource/views/img/${item.getWineImg1()}"
