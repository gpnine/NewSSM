			...
			<div class="infor">
				...
				<div class="goods_list">
					...
					<div class="finsh" style="position: relative;">
						...
						<span class="money1">应付金额：<span class="total_price" style="color: red;font-size: 16px;font-weight: bolder;">399</span>元</span>
						<a class="tijiao" style="position: absolute;cursor:pointer;display:none;right:20px;top:5px;width:100px;height:40px;" href=""><button style="background: #FC6E75;color:white;text-align:center;line-height:20px;width:100px;height:40px;">提交订单</button></a>
					</div>
