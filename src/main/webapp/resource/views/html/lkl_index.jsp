...
<html lang="en">
	<head>
		...
		<link rel="shortcut icon" href="logo.png" type="image/x-icon">
			<link rel="stylesheet" type="text/css" href="http://10.80.13.161:8081/resource/views/css/lkl_headandfoot.css"/>
			<link rel="stylesheet" type="text/css" href="http://10.80.13.161:8081/resource/views/css/lkl_base.css"/>
			<link rel="stylesheet" type="text/css" href="http://10.80.13.161:8081/resource/views/css/lkl_index.css"/>
			<link rel="stylesheet" type="text/css" href="http://10.80.13.161:8081/resource/views/css/lkl_iconfont.css">
	</head>
	<body>
		<div class="topBox">
			<div class="top">
				...
				<div class="top_right">
					...
					<div class="weixinInter">
						<span>微信端</span>
						<img src="http://10.80.13.161:8081/resource/views/img/weixinCode.png" />
					</div>
					<div class="app">
						<span>App</span>
						<img src="../img/app.png"/>
		...
		<ol class="content">
				...
				<div style="width:1190px;border-top:1px solid gray;margin-top:-2px;">
					<ol class="hot_sell_list clearfix">
						<li class="hot_sell_list_li">
							<a class="hot_sell a" href=""><img src="../img/0.jpg"></a>
						</li>
						<li class="hot_sell_list_li">
							<a class="hot_sell a" href=""><img src="../img/0.jpg"></a>
						</li>
											...
											<div class="jiupin_first_swiper_box">
												<div class="jiupin_first_swiper_box_imgs clearfix">
													...
													<div class="jiupin_first_swiper_box_imgs_four">
														<img class="jiupin_first_swiper_box_imgs_four_img" src="../img/7.jpg" alt="" />
														<img class="jiupin_first_swiper_box_imgs_four_img" src="../img/7.jpg" alt="" />
														<!--<img class="jiupin_first_swiper_box_imgs_four_img" src="../img/7.jpg" alt="" />-->
														<img class="jiupin_first_swiper_box_imgs_four_img" src="../img/7.jpg" alt="" />
													</div>
			...
			<li class="qijiandian">
				...
				<div>
					<ol class="clearfix">
						<li class="fl"><img src="../img/9.jpg"/></li>
						...
						<li  class="fr"><img src="../img/8.jpg"/></li>
		...
		<footer>
			...
			<div class="href_table">
				<table border="" cellspacing="0" cellpadding="0">
					<tr>
						<td rowspan="2" style="text-align: start;"><a href="###"><img src="../img/bottom_1.png"/></a></td>
						<th>购物指南</th>
						<th>配送说明</th>
						<th>支付方式</th>
						<th>售后服务</th>
					...
					<tr>	
					<td rowspan="2" style="text-align: start;"><a href="###"><img src="../img/bottom_2.png"/></a></td>
					...
					<tr>
						<td rowspan="3" style="text-align: start;"><a href="###"><img src="../img/bottom_3.png"/></a></td>
						<td><a href="###">关于发票</a></td>
						<td><a href="###"></a></td>
						<td><a href="###"></a></td>
				...
				<div class="href_table_right">
					<div>
						<span>手机中酒</span>
						<img src="../img/phone_zj.png"/>
						<span>下载移动客户端</span>
					</div>
					<div>
						<span>中酒微信</span>
						<img src="../img/weixin_zj.png"/>
						<span>中酒官方微信</span>
					</div>
				</div>
			</div>
