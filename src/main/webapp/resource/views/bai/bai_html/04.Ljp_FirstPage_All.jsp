...
<head>
    ...
    %>
    <meta charset="UTF-8">
    <link rel="stylesheet" type="text/css" href="<%=basePath%>/resource/views/bai/bai_css/04.Ljp_FirstPage_All.css"/>
    <link rel="stylesheet" type="text/css" href="<%=basePath%>/resource/views/bai/bai_css/jquery.pagination.css"/>
    <title>白酒的更多</title>
</head>
<body>
<!--上方的红线-->
...
<div class="head_name">
    ...
    <span class="sele_kind1"><a href="">白酒</a>&nbsp;&nbsp;&nbsp;<span><a href="">X</a></span></span>
    <span class="goods_amount">共 <span>868</span> 个商品</span>
</div>
...
<div class="part_one">
    <div class="left_part">
        ...
        <div class="all_kind">
            ...
            <div class="jiu_kind">
                <span class="san_jiao"><img src="<%=basePath%>/resource/views/bai/img/ljp_52.png"/></span>&nbsp;&nbsp;&nbsp;
        ...
        <div class="hot_sell">
            ...
            <ul class="hot_good_a">
                <!--<li>
                    <a href="">
                        <div class="hot_img">
                            <img src="../img/ljp_59.jpg" alt="" />
                        </div>
                        <div class="hot_info">
                            <span class="info_name">52°五粮液股份有限公司永不分离精品500ml（6瓶装）</span>
                            <span class="info_price">￥<span>149.00</span></span>
                        </div>
                    </a>
                </li>-->
                <!--<li></li>
        ...
        <div class="look_recode">
            ...
            <ul class="recode_goods">
                <!--<li>
                    <a href=""><div class="recode_goods_img">
                        <img src="../img/ljp_60.jpg" alt="" />
                        </div>
                        <p class="recode_goods_name">52°五粮液华彩人生30典藏 500ml</p>
                        <p class="recode_goods_price">￥<span>139.00</span></p>
                        <p class="recode_goods_pls">评论数：<span>3400</span></p>
                    </a>
                </li>
                <li></li>
                <li></li>
    ...
    <div class="right_part">
        ...
        <div class="sele_all">
            <div class="pin_pai">
                ...
                <div class="btn btn_one"><img src="<%=basePath%>/resource/views/bai/img/ljp_53.png"/></div>
            </div>
            ...
            <div class="cd_one">
                ...
                <div class="btn btn_two"><img src="<%=basePath%>/resource/views/bai/img/ljp_53.png"/></div>
            </div>
            ...
            <div class="ds">
                ...
                <div class="btn btn_three"><img src="<%=basePath%>/resource/views/bai/img/ljp_53.png"/></div>
            </div>
        </div>
...
<script src="<%=basePath%>/resource/views/bai/bai_js/jquery.pagination.min.js"></script>
<script>
    //点击侧边栏的三角形，打开关闭
...
//动态生成选项卡数据
            ...
            for (var i = 0; i < b_imgArr.length; i++) {
                if (i < 7) {
                    $("<li class=\"pai_img\"><img src=\"<%=basePath%>/resource/views/bai/img/logo/" + b_imgArr[i] + "\" /></li>").prependTo($(".liS"));
                } else {
                    $("<li class=\"pai_img\"><img src=\"<%=basePath%>/resource/views/bai/img/logo/" + b_imgArr[i] + "\" /></li>").prependTo($(".display_one"));
                }
            }
            //hover的文字
            var pai_img = $(".pai_img");
            ...
            for (var i = 0; i < pai_img.length; i++) {
                ...
                pai_img[i].onmouseout = function () {
                    this.innerHTML = "<img src=\"<%=basePath%>/resource/views/bai/img/logo/" + b_imgArr[this.index] + "\"/>";
                    this.style.border = "";
...
//		console.log(data5);
            ...
            for (var i = 0; i < b_degreeArr.length; i++) {
                if (i < 10) {
                    $("<li><span><a href=\"\" class=\"li_a\">" + b_degreeArr[i] + "</span>%Vol.</a></li>").prependTo($(".lis_du"));
                } else {
                    $("<li><span><a href=\"\" class=\"li_a\">" + b_degreeArr[i] + "</span>%Vol.</a></li>").prependTo($(".display_three"));
                }
            }
...
//					console.log(wineBig);
                        ...
                        html += '<li class="goods"><a class="aa" href=""><img src="<%=basePath%>/resource/views/bai/img/wine/' + wineBig + '" alt="' + i + '" class="wineBig"/></a><div class="bottom"><div class="pri_deal"><span class="price">￥<span>' + winePrice + '</span></span><span class="deal">成交<span> ' + wineEvaCount + ' </span>笔</span></div><p class="jiu_name"><a href=""><span>' + wineDegree + '°</span><span class="w_N">' + wineName + '</span> <span>' + wineLiter + '</span></a></p><p class="zjzy"><a href="">' + wineCity + '</a></p></div><div class="small_pic"><img class="w_s1" src="<%=basePath%>/resource/views/bai/img/wine/' + wineSmall1 + '" alt="" /><img class="w_s2" src="<%=basePath%>/resource/views/bai/img/wine/' + wineSmall2 + '" alt="" /><img class="w_s3" src="<%=basePath%>/resource/views/bai/img/wine/' + wineSmall3 + '" alt="" /><img class="w_s4" src="<%=basePath%>/resource/views/bai/img/wine/' + wineSmall4 + '" alt="" /></div></li>';
...
//				console.log(hot_ImgArr);
                    var cont = "";
                    for (i in hot_ImgArr) {
                        cont += '<li><a href=""><div class="hot_img"><img src="<%=basePath%>/resource/views/bai/img/wine/' + hot_ImgArr[i] + '" alt="" /></div><div class="hot_info"><span class="info_name"><span>' + hot_DegreeArr[i] + '</span>°<span>' + hot_NameArr[i] + '</span><span>' + hot_MLArr[i] + '</span></span><span class="info_price">￥<span>' + hot_PriceArr[i] + '</span></span></div></a></li>';
                    }
                    ...
                    var content = "";
                    for (i in hot_ImgArr) {
                        content += '<li><a href=""><div class="recode_goods_img"><img src="<%=basePath%>/resource/views/bai/img/wine/' + hot_ImgArr[i] + '" alt="" /></div><p class="recode_goods_name"><span>' + hot_DegreeArr[i] + '</span>°' + hot_NameArr[i] + ' <span>' + hot_MLArr[i] + '</span></p><p class="recode_goods_price">￥<span>' + hot_PriceArr[i] + '</span></p><p class="recode_goods_pls">评论数：<span>3400</span></p></a></li>';
                    }
