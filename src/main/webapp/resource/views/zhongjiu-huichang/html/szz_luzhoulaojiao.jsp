...
<head>
    ...
    %>
    <meta charset="UTF-8">
    <title>中酒网-泸州老窖品牌专场</title>
    <link rel="stylesheet" type="text/css"
          href="<%=basePath%>/resource/views/zhongjiu-huichang/css/szz_luzhoulaojiao.css"/>
...
<!-- 底部 -->
<footer style="margin-top: 4575px;">
</footer>
</body>
...
<script>
    ...
    $.ajax({
        url: "<%=basePath%>/huichang/luzhoulaojiao.do",
        type: "get",
        data: {},
        dataType: "json",
        success: function (data) {
            ...
            //大标题下的一张图占一列的部分
            for (var j = 0; j < data.luzhoulaojiaodaT1.length; j++) {
                var a = document.createElement("a");
                a.href = "###";
                var span = document.createElement("span");
                span.className = "price";
                span.innerHTML = data.luzhoulaojiaodaT1[j].huichangname;
                var img1 = document.createElement("img");
                img1.src = "<%=basePath%>/resource/views/img/huichang/" + data.luzhoulaojiaodaT1[j].huichangimg;
                a.appendChild(span);
                a.appendChild(img1);
...
//		img.src = "http://img5.zhongjiu.cn/pro/xp16/xplx-6.jpg";
//		baokuan.appendChild(img);
            ...
            for (var n = 0; n < data.luzhoulaojiaoWines1.length; n++) {
                var a2 = document.createElement("a");
                a2.href = "###";
                var span2 = document.createElement("span");
                span2.className = "jieshao";
                span2.innerHTML = data.luzhoulaojiaoWines1[n].wineDegree + "°" + data.luzhoulaojiaoWines1[n].wineName + data.luzhoulaojiaoWines1[n].wineLiter;
                var span3 = document.createElement("span");
                span3.className = "adText";
                span3.innerHTML = data.luzhoulaojiaoWines1[n].wineEvalution;
                var span4 = document.createElement("span");
                span4.className = "price";
                span4.innerHTML = "<b style='font-size:12px'>￥</b>" + data.luzhoulaojiaoWines1[n].winePrice;

                var span5 = document.createElement("span");
                span5.className = "goumaiPic";
                var img3 = document.createElement("img");
                img3.src = "<%=basePath%>/resource/views/img/huichang/" + data.luzhoulaojiaoWines1[n].wineImg1;
