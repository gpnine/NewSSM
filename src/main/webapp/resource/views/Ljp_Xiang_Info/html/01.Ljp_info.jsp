    ...
    <div class="main_box">
        ...
        <div class="main_left">
            ...
            <ul class="left_smallpic">
                <li class="leftPic1 leftPic"><a href=""><img style="width: 100%;height: 100%;"
                                                             src="<%=basePath%>/resource/views/img/${wineInfo.getWineImg1()}"
                                                             alt="" class="smallpic1 smallpic"/></a></li>
                <li class="leftPic2 leftPic"><a href=""><img style="width: 100%;height: 100%;"
                                                             src="<%=basePath%>/resource/views/img/${wineInfo.getWineImg2()}"
                                                             alt="" class="smallpic2 smallpic"/></a></li>
                <li class="leftPic3 leftPic"><a href=""><img style="width: 100%;height: 100%;"
                                                             src="<%=basePath%>/resource/views/img/${wineInfo.getWineImg3()}"
                                                             alt="" class="smallpic3 smallpic"/></a></li>
                <li class="leftPic4 leftPic"><a href=""><img style="width: 100%;height: 100%;"
                                                             src="<%=basePath%>/resource/views/img/${wineInfo.getWineImg4()}"
                                                             alt="" class="smallpic4 smallpic"/></a></li>
                <li class="leftPic5 leftPic"><a href=""><img style="width: 100%;height: 100%;"
                                                             src="<%=basePath%>/resource/views/img/${wineInfo.getWineImg5()}"
                                                             alt="" class="smallpic5 smallpic"/></a></li>
            </ul>
        </div>
        ...
        <div class="right_info">
            ...
            <div class="button">
                <span class="btn1">
                    <a href="<%=basePath%>/resource/views/gouwuche/html/lkl_gouwuche.html?wid=${wid}">
                        <img src="<%=basePath%>/resource/views/Ljp_Xiang_Info/img/ljp_31.png"/>
                    </a>
                </span>
    ...
    <div class="left_big">
        ...
        <div class="right_goodsInfo">
            ...
            <div class="zx" id="spzx">
                ...
                <p class="zx_tips">
                    温馨提示:因厂家更改产品包装、产地或者更换随机附件等没有任何提前通知，且每位咨询者购买情况、提问时间等不同，为此以下回复仅对提问者3天内有效，其他网友仅供参考！若由此给您带来不便请多多谅解，谢谢！</p>
            </div>
