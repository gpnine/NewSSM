		...
		<footer>
			...
			<div class="href_table">
				<table border="" cellspacing="0" cellpadding="0">
					<tr>
						<td rowspan="2" style="text-align: start;"><a href=""><img src="<%=basePath%>/resource/views/Ljp_FirstPage_All2/headAndfoot_img/bottom_1.png"/></a></td>
						<th>购物指南</th>
						<th>配送说明</th>
						<th>支付方式</th>
						<th>售后服务</th>
					...
					<tr>	
					<td rowspan="2" style="text-align: start;"><a href=""><img src="<%=basePath%>/resource/views/Ljp_FirstPage_All2/headAndfoot_img/bottom_2.png"/></a></td>
					...
					<tr>
						<td rowspan="3" style="text-align: start;"><a href=""><img src="<%=basePath%>/resource/views/Ljp_FirstPage_All2/headAndfoot_img/bottom_3.png"/></a></td>
						<td><a href="">关于发票</a></td>
						<td><a href=""></a></td>
						<td><a href=""></a></td>
				...
				<div class="href_table_right">
					<div>
						<span>手机中酒</span>
						<img src="<%=basePath%>/resource/views/Ljp_FirstPage_All2/headAndfoot_img/phone_zj.png"/>
						<span>下载移动客户端</span>
					</div>
					<div>
						<span>中酒微信</span>
						<img src="<%=basePath%>/resource/views/Ljp_FirstPage_All2/headAndfoot_img/weixin_zj.png"/>
						<span>中酒官方微信</span>
					</div>
				</div>
			</div>
			...
			<div class="bottom_last">
				...
				<div>
					...
					<a href="">
						<img src="<%=basePath%>/resource/views/Ljp_FirstPage_All2/headAndfoot_img/kexin.png"/>
					</a>
					<a href="">
