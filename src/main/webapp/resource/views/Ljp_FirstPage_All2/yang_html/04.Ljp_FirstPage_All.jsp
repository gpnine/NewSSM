...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="<%=basePath%>/resource/views/Ljp_FirstPage_All2/yang_css/04.Ljp_FirstPage_All.css"/>
    <link rel="stylesheet" type="text/css"
          href="<%=basePath%>/resource/views/Ljp_FirstPage_All2/yang_css/jquery.pagination.css"/>
    <title>洋酒的更多</title>
</head>
<body>
...
<div class="part_one">
    <div class="left_part">
        ...
        <div class="all_kind">
            ...
            <div class="white_jiu"><a>洋酒</a></div>
        </div>
    ...
    <div class="right_part">
        ...
        <div class="sele_all">
            ...
            <div class="xx">
                <div class="xiang field">洋酒类型：</div>
...
<script>
    ...
    var b_adressArr0 = [];//洋酒的产地
    var b_shiyong1Arr = [];//洋酒的适用
    var b_yangjiuArr = [];//洋酒类型
    $.ajax({
...
//		console.log(data3);
    ...
    $(function () {
        ...
        function renderList(current) {
            ...
            //热卖的数据
            $.ajax({
                url: "<%=basePath%>/index/findScope.do?a=3001&b=4000",
                type: "get",
                dataType: "json",
                async: true,
                success: function (data) {
